...
void main() {
  ...
  group('HttpClient.delete() request', () {
    group('works with', () {
      test('json body', () async {
        final result = await http.delete<JsonObject>(
          path: mockTest,
          body: mockBodyJson,
        );
      ...
      test('string response', () async {
        final result = await http.delete<String>(
          path: mockSuccess,
        );
      ...
      test('list response', () async {
        final result = await http.delete<JsonArray>(
          path: mockList,
        );
    ...
    group('invalid response', () {
      test(
        ...
        final result = http.delete<String>(
          path: mockError,
        );
